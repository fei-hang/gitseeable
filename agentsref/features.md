...
- **Local file keyboard nav**: On local changes page, ArrowDown/ArrowUp select next/previous file and load its diff (staged first, then unstaged). Skips when focus is in an input/textarea. File list auto-scrolls to keep the selected item visible.
